...
<body>
    ...
    <p>If you post or otherwise display any of your or your employer’s own content on the Site, you hereby grant electrik a non-exclusive, perpetual, royalty-free, paid-up, worldwide license, with right to sub-license, to copy. modify, distribute, display, perform, make, use and sell (or sub-license, as applicable) such content.
    </p>
    ...
    <ol>
        ...
        <li>A description of where the material that you claim is infringing is located on our Website;
        </li>
        <li>Information reasonably sufficient to permit electrik to contact you, such as an address, telephone number, and if available, an electronic mail address at which you may be contacted;
        </li>
        <li>A statement that you have a good faith belief that the disputed use of the material is not authorized by the copyright owner, its agent, or the law; and
        </li>
        <li>A statement by you, made under penalty of perjury, that the information in your notification is accurate, and that you are the copyright owner or are authorized to act on behalf of the copyright owner.
        </li>
    </ol>


    <p>Upon receipt of the written Notification containing the information as outlined in 1 through 5 above:
    </p>

    <ol>
        <li>Electrik shall remove or disable access to the material that is alleged to be infringing;</li>
        <li>Electrik shall forward the written notification to such alleged infringer ("Subscriber");
        </li>
        <li>Electrik  shall take reasonable steps to promptly notify the Subscriber that it has removed or disabled access to the material.
        </li>     
    </ol>
    ...
    <ol>
        <li>A physical or electronic signature of the Subscriber;
        </li>
    ...
    <ol>
        <li>Electrik  shall promptly provide you, the complaining party, with a copy of the Counter Notification;
        </li>
        <li>Electrik shall inform you that it will replace the removed material or cease disabling access to it within ten (10) business days;
        </li>
        <li>Electrik shall replace the removed material or cease disabling access to the material within ten (10) to fourteen (14) business days following receipt of the Counter Notification, provided electrik's Designated Agent has not received notice from you that an action has been filed seeking a court order to restrain Subscriber from engaging in infringing activity relating to the material on electrik's network or system.
        </li>
    </ol>
