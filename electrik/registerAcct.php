...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.10.2/dist/umd/popper.min.js"
    integrity="sha384-lhQfs5gIvKGp8r+8Em+RmA8w2/3cGLCnUc9/7IeDJdzmfa/iRs2t5u8Zn6QAr4p" crossorigin="anonymous"></script>
...
<body>
  ...
  <form action="/validateRegister.php" method="post">
    <div class="container">
      ...
      <input type="password" placeholder="Confirm Password" name="cfrmpwd" required>
